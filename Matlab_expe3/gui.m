...
% Last Modified by GUIDE v2.5 04-Dec-2016 19:36:53
...
% --- Executes on button press in sobelOperatorRadio.
function sobelOperatorRadio_Callback(hObject, eventdata, handles)
% hObject    handle to sobelOperatorRadio (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
%将功能设置为Sobel算子分割
handles.fcn = @sobelOperator;
guidata(hObject,handles);

% Hint: get(hObject,'Value') returns toggle state of sobelOperatorRadio


% --- Executes on button press in prewittOperatorRadio.
function prewittOperatorRadio_Callback(hObject, eventdata, handles)
% hObject    handle to prewittOperatorRadio (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
%将功能设置为Prewitt算子分割
handles.fcn = @prewittOperator;
guidata(hObject,handles);

% Hint: get(hObject,'Value') returns toggle state of prewittOperatorRadio


% --- Executes on button press in robertsOperatorRadio.
function robertsOperatorRadio_Callback(hObject, eventdata, handles)
% hObject    handle to robertsOperatorRadio (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
%将功能设置为Roberts算子分割
handles.fcn = @robertsOperator;
guidata(hObject,handles);

% Hint: get(hObject,'Value') returns toggle state of robertsOperatorRadio


% --- Executes on button press in logOperatorRadio.
function logOperatorRadio_Callback(hObject, eventdata, handles)
% hObject    handle to logOperatorRadio (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
%将功能设置为Log算子分割
handles.fcn = @logOperator;
guidata(hObject,handles);

% Hint: get(hObject,'Value') returns toggle state of logOperatorRadio


% --- Executes on button press in cannyOperatorRadio.
function cannyOperatorRadio_Callback(hObject, eventdata, handles)
% hObject    handle to cannyOperatorRadio (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
%将功能设置为Canny算子分割
handles.fcn = @cannyOperator;
guidata(hObject,handles);

% Hint: get(hObject,'Value') returns toggle state of cannyOperatorRadio
